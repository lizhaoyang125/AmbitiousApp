...
### 5. 店铺类型可售商品配置 `STORE_TYPE_ITEMS`

```typescript
const STORE_TYPE_ITEMS: Record<StoreType, IItemData[]> = {
  // ============================================
  // 便利店 (convenience)
  // ============================================
  convenience: [
...
type StoreType = 'convenience' | 'clothing' | 'flowers' | 'electronics';
```
...
interface IPlayerData {
  ...
  // 解锁状态
  unlockedStoreTypes: Array<'convenience' | 'clothing' | 'flowers' | 'electronics'>;
...
interface IStoreData {
  id: string;
  name: string;
  type: 'convenience' | 'clothing' | 'flowers' | 'electronics';
